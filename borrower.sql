...
BEGIN
 ...
 VALUES (v_roll_no, TO_DATE('12-10-2022', 'DD-MM-YYYY'), v_fine_amt);  UPDATE Borrower
 SET Status = 'R'
 WHERE Roll_no = v_roll_no AND Book_name = v_book_name;
 DBMS_OUTPUT.PUT_LINE('Fine Amount: Rs ' || v_fine_amt);  ELSE
 RAISE_APPLICATION_ERROR(-20001, 'Book not issued or already returned');  END IF;
EXCEPTION
