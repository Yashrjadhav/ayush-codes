...
temp_marks number(5);  temp_name varchar2(20);
BEGIN
...
DECLARE
 ...
 temp_marks number(5);
BEGIN
 FOR student_rec IN (SELECT Roll_no, Student_Name, Total_Marks FROM STUD_MARKS)  LOOP
 temp_roll := student_rec.Roll_no;  temp_name := student_rec.Student_Name;
