...
VALUES(:OLD.Roll_no,:OLD.Student_Name,:OLD.DATE_OF_ISSUE,:OLD.Book_Name,:OLD.Status);
END;
/
...
update lib_table set rollno=36 where studentname='ash';
DELETE from lib_table where rollno=39;
select * from lib_audit;
